 ...
 */
#define TEMPSENSORS_NUM 1
#define TEMP_SENSOR_0 11 // This is thermistor 0
...
#define HOT_AIR_MAXTEMP 270
#define HOT_AIR_MINTEMP 25
//TIME IN SECOND FOR MINIMUM TEMPERATURE CHANGE TO OCCUR ELSE THERMAL RUNAWAY WILL TRIGGER
#define THEMAL_RUNAWAY_TIMEOUT_HOTAIR0 120
#define MINIMUM_TEMPERATURE_CHANGE_HOTAIR0 5
